...
public class DirectoryHasherTest {
	...
	DirectoryHasher dh = new DirectoryHasher(fileQueue);
	
	@Before
	public void setUp() throws Exception {
		tempDir  = Files.createTempDirectory("DirectoryHasherTest").toFile();
		bfr.write(testData, new File(tempDir,"testFile1").toString());
		bfr.write(testData2, new File(tempDir,"testFile2").toString());
